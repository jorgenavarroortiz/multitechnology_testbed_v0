...
usage() {
  ...
  echo ""
  echo "E.g. for mptcpProxy: $0 -p fullmesh -s default -c olia -f if_names.txt.scenario1_different_networks_RPi1_wifi -u 2 -m -o server"
  echo "E.g. for mptcpUe:    $0 -p fullmesh -s default -c olia -f if_names.txt.scenario1_different_networks_RPi2_wifi -u 2 -m -o client -S 10.1.1.1";
  echo ""
