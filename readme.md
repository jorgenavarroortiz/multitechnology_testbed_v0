...
Please use [i2CAT's scenario 2](https://github.com/jorgenavarroortiz/5g-clarity_testbed_v0#launching-the-free5gc-testbed) in the meantime. You can watch a [video showing how it works (using i2CAT's scripts, to be updated)](https://www.youtube.com/watch?v=S5ocC49i4Uk).
