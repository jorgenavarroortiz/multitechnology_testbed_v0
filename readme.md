...
- **mptcpUe VM**: `eth1`, `eth2` and `eth3` are configured for using an internal network (ue_5gc) instead of using a bridged adapter. Access to this VM is available through **SSH on port 12222**.
